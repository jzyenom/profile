...
//     } else {
//       newCode[index] = value; // Fix: Store the value in the state
//       setCode(newCode);
...
//         className="bg-gray-800 opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-2xl p-8 w-full max-w-md"
//       >
...
//                 className="w-12 h-12 text-center text-2xl font-bold bg-gray-700 text-white border-2 border-gray-500 rounded-lg focus:outline-none"
//               />
//             ))}
//           </div>
